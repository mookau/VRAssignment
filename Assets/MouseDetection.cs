...
public class MouseDetection : MonoBehaviour
{
    ...
    //-------------------------------------------------------------------------------------------------------------
    //File names
    string effectFileName = "effectsText.txt";
    string testScreenFileName = "testInfoScreenText.txt";
    string questionFileName = "";

    //Total String values
    string textEffectString = "";
    string testScreenString = "";
    ...
    ColorBlock OnShaderGreen;
    ColorBlock OffShaderRed;
    ColorBlock DisabledButton;

    Color onColour = new Color((float)0.423529, (float)0.866666, (float)0.505882);
    Color offColour = new Color((float)0.631372, (float)0.501960, (float)0.454901);
    Color answerUnselected = new Color((float)0.811764, (float)0.749019, (float)0.709803);
    Color answerSelected = new Color((float)0.360789, (float)0.239215, (float)0.192156);
    ...
    void Start()
    {
        ...
        optionsEditBox = GameObject.Find("OptionsTrialText").GetComponent<Text>();
        optionsNoneBox = GameObject.Find("OptionsTestText").GetComponent<Text>();

        effectEditBox = GameObject.Find("EffectsTrialText").GetComponent<Text>();
        effectNoneBox = GameObject.Find("EffectsTestText").GetComponent<Text>();

        startScreenText = GameObject.Find("DescriptionText").GetComponent<Text>();

        testEditBox = GameObject.Find("TestSettingsTrialText").GetComponent<Text>();
        testNoneBox = GameObject.Find("TestSettingsTestText").GetComponent<Text>();


        loadTextFile(effectFileName, 1);
        loadTextFile(testScreenFileName, 3);
        loadTextFile("", 4);
...
/*        if(screenName.Equals("ResultsScreenExample"))
    ...
    void optionsExampleButtonHandler(int buttonNumber, int changeVal, string fontName)
    {
        if (buttonNumber == 0)
        {
            ...
            {
                //colour onColour = new Color(94 / 255, 191 / 255, 112 / 255);
                //colour offColour = new Color(191 / 255, 152 / 255, 138 / 255);
                
                //GameObject.Find("EOLBox").transform.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(108, 221, 219, 255);
                //GameObject.Find("EOLBox").transform.Find("0.0.0").GetComponent<Renderer>().material.color = new Color(161, 128, 116, 255);

                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(0, 0, 0);
                //print("a: " + GameObject.Find("0.0.1").GetComponent<Renderer>().material.color.ToString());
                GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = onColour;
                GameObject.Find("0.0.0").GetComponent<Renderer>().material.color = offColour;
                //print("a: " + GameObject.Find("0.0.1").GetComponent<Renderer>().material.color.ToString());
                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(108, 221, 129, 255);
                //GameObject.Find("0.0.0").GetComponent<Renderer>().material.color = new Color(0, 0, 0);
                //print("b: " + GameObject.Find("0.0.0").GetComponent<Renderer>().material.color.ToString());

                //print("b: " + GameObject.Find("0.0.0").GetComponent<Renderer>().material.color.ToString());
                //GameObject.Find("0.0.0").GetComponent<Renderer>().material.color = new Color(161, 128, 116, 255);

            }
            else 
            {
                //GameObject.Find("0.0.0").GetComponent<Button>().colors = DisabledButton;
                //GameObject.Find("0.0.1").GetComponent<Button>().colors = OnShaderGreen;

                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(161, 128, 116, 255);
                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(0, 0, 180, 255);
                //GameObject.Find("0.0.0").GetComponent<Renderer>().material.color = new Color(0, 255, 0, 255);
                GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = offColour;
                GameObject.Find("0.0.0").GetComponent<Renderer>().material.color = onColour;
            }
        ...
        else if (buttonNumber == 1)
        {
            ...
            if (textJustificationOne)
            {
                ...
                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(0, 0, 0);
                //print("a: " + GameObject.Find("0.0.1").GetComponent<Renderer>().material.color.ToString());
                GameObject.Find("0.1.1").GetComponent<Renderer>().material.color = onColour;
                GameObject.Find("0.1.0").GetComponent<Renderer>().material.color = offColour;
                //print("a: " + GameObject.Find("0.0.1").GetComponent<Renderer>().material.color.ToString());
                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(108, 221, 129, 255);
                //GameObject.Find("0.0.0").GetComponent<Renderer>().material.color = new Color(0, 0, 0);
                //print("b: " + GameObject.Find("0.0.0").GetComponent<Renderer>().material.color.ToString());
            ...
            else
            {
                ...
                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(0, 0, 180, 255);
                //GameObject.Find("0.0.0").GetComponent<Renderer>().material.color = new Color(0, 255, 0, 255);
                GameObject.Find("0.1.1").GetComponent<Renderer>().material.color = offColour;
                GameObject.Find("0.1.0").GetComponent<Renderer>().material.color = onColour;
            }
        }
        else if (buttonNumber == 2)
        {
            ...
            if (textReversalOne)
            {
                ...
                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(0, 0, 0);
                //print("a: " + GameObject.Find("0.0.1").GetComponent<Renderer>().material.color.ToString());
                GameObject.Find("0.2.1").GetComponent<Renderer>().material.color = onColour;
                GameObject.Find("0.2.0").GetComponent<Renderer>().material.color = offColour;
                //print("a: " + GameObject.Find("0.0.1").GetComponent<Renderer>().material.color.ToString());
                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(108, 221, 129, 255);
                //GameObject.Find("0.0.0").GetComponent<Renderer>().material.color = new Color(0, 0, 0);
                //print("b: " + GameObject.Find("0.0.0").GetComponent<Renderer>().material.color.ToString());
            ...
            else
            {
                ...
                //GameObject.Find("0.0.1").GetComponent<Renderer>().material.color = new Color(0, 0, 180, 255);
                //GameObject.Find("0.0.0").GetComponent<Renderer>().material.color = new Color(0, 255, 0, 255);
                GameObject.Find("0.2.1").GetComponent<Renderer>().material.color = offColour;
                GameObject.Find("0.2.0").GetComponent<Renderer>().material.color = onColour;
            }
        }
    ...
    */
    void textEffectsExampleButtonHandler(int buttonNumber, int changeVal, string fontName)
    {
        if (buttonNumber == 0)
        {
            ...
            if (riversTwo)
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = onColour;
                GameObject.Find("1.0.0").GetComponent<Renderer>().material.color = answerSelected;
            }
            else
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = offColour;
                GameObject.Find("1.0.0").GetComponent<Renderer>().material.color = answerUnselected;
            }
        }
        else if (buttonNumber == 1)
        {
            ...
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = onColour;
                GameObject.Find("1.1.0").GetComponent<Renderer>().material.color = answerSelected;
            }
            else
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = offColour;
                GameObject.Find("1.1.0").GetComponent<Renderer>().material.color = answerUnselected;
            }
        }
        else if (buttonNumber == 2)
        {
            ...
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = onColour;
                GameObject.Find("1.2.0").GetComponent<Renderer>().material.color = answerSelected;
            }
            else
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = offColour;
                GameObject.Find("1.2.0").GetComponent<Renderer>().material.color = answerUnselected;
            }
        }
        else if (buttonNumber == 3)
        {
            ...
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = onColour;
                GameObject.Find("1.3.0").GetComponent<Renderer>().material.color = answerSelected;
            }
            else
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = offColour;
                GameObject.Find("1.3.0").GetComponent<Renderer>().material.color = answerUnselected;
            }
        }
        else if (buttonNumber == 4)
        {
            ...
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = onColour;
                GameObject.Find("1.4.0").GetComponent<Renderer>().material.color = answerSelected;
            }
            else
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = offColour;
                GameObject.Find("1.4.0").GetComponent<Renderer>().material.color = answerUnselected;
            }
        }
        else if (buttonNumber == 5)
        {
            ...
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = onColour;
                GameObject.Find("1.5.0").GetComponent<Renderer>().material.color = answerSelected;
            }
            else
            {
                //GameObject.Find("RiversButton").transform.Find("Tab1").GetComponent<Renderer>().material.color = offColour;
                GameObject.Find("1.5.0").GetComponent<Renderer>().material.color = answerUnselected;
            }
        }
    ...
    public void loadTextFile(string textFileName, int executionCode)
    {
        if (executionCode == 0)
        {
            print(Directory.GetCurrentDirectory() + "\\PUT_LOAD_FILES_HERE!!!!\\questionTxt.JSON");
        ...
        {
            using (StreamReader r = new StreamReader(Directory.GetCurrentDirectory() + "\\PUT_LOAD_FILES_HERE!!!!\\" + textFileName))
            {
                textEffectString = r.ReadToEnd();
                
                optionsEditBox.text = textEffectString;
                optionsNoneBox.text = textEffectString;
                effectEditBox.text = textEffectString;
                effectNoneBox.text = textEffectString;
            }
        ...
        else if (executionCode == 2)
        {
            using (StreamReader r = new StreamReader(Directory.GetCurrentDirectory() + "\\PUT_LOAD_FILES_HERE!!!!\\" + textFileName))
            {
                string textEffectString = r.ReadToEnd();
                effectEditBox.text = textEffectString;
                effectNoneBox.text = textEffectString;
            }

        }
        else if (executionCode == 3)
        {
            using (StreamReader r = new StreamReader(Directory.GetCurrentDirectory() + "\\PUT_LOAD_FILES_HERE!!!!\\" + textFileName))
            {
                testScreenString = r.ReadToEnd();
                startScreenText.text = testScreenString;
                
            }
        }
        else if (executionCode == 4)
        {
            questionString = listQuestionStorage[0].question;
            testEditBox.text = questionString;
            testNoneBox.text = questionString;
